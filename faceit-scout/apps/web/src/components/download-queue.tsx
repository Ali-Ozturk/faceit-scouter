...
const labels: Record<string, string> = {
  ...
  WAITING_FOR_BATCH: "Waiting for other uploads",
...
export function DownloadQueue({ jobs }: { jobs: Job[] }) {
  ...
  return <section className="rounded border bg-white p-4">
    ...
    <p className="my-2 text-sm text-slate-600">Up to 9 pending imports. Files selected together enter processing after every upload in their batch finishes or is cancelled. Completed demo files are deleted; match results remain available.</p>
